...
python:  ## Setup python dev environment
	...
	@pip3 install multidict yarl async_timeout idna_ssl aiosignal aiohttp nndownload==1.11 \
          tinydb peewee pocket-api BeautifulSoup4 toml emoji feedparser youtube-dl tqdm isort \
		  flake8 pylint Wand
